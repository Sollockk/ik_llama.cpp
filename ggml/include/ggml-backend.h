...
extern "C" {
    ...
    */
    ...
    // Get the device copy of a tensor for a specific backend (used for JIT overlay GPU re-upload).
    ...
    GGML_API void                 ggml_backend_sched_set_ring_experts(ggml_backend_sched_t sched, bool on_or_off);
